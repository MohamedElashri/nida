...
func buildReleaseNotes(changelog []byte) []byte {
	...
	body = strings.TrimPrefix(body, "All notable changes to Nida are documented here.")
	body = strings.TrimSpace(body)

	var out bytes.Buffer
	out.WriteString("+++\n")
	out.WriteString("title = \"Release Notes\"\n")
	out.WriteString("description = \"Release notes generated from the Nida changelog.\"\n")
	out.WriteString("weight = 60\n")
	out.WriteString("template = \"page\"\n")
	out.WriteString("+++\n\n")
	out.WriteString("This page is generated from [CHANGELOG.md](https://github.com/MohamedElashri/nida/blob/main/CHANGELOG.md).\n\n")
